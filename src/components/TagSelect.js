  ...
  render() {
    ...
    return (
      <CreatableSelect
        ...
        styles={{multiValue: (styles, { data }) => { console.log("data", data); return {...styles, backgroundColor: this.props.categories.find(cat=> cat.id === data.value) !== undefined ? this.props.categories.find(cat=> cat.id === data.value).color :'rgb(224,255,255)'};},     valueContainer: base => ({
            ...base,
            maxHeight: '2.4rem'
        }),}}
      />
